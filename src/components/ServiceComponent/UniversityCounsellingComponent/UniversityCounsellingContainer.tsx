...
const UniversityCounsellingContainer = () => {
  ...
  return (
    <>
      ...
      <Box sx={{ backgroundColor: '', width: '100%', padding: isMobileSize ? '2rem 1rem' : isTabletSize ? '4rem 3.5rem' : '4rem 7rem', display: 'flex', justifyContent: 'center', columnGap: '30px', alignItems: 'center' }}>
        ...
        {!isMobileSize && <Card sx={{ width: '48%', height: isMobileSize ? '250px' : isTabletSize ? '250px' : isDesktopSize ? '50vh' : '430px', borderRadius: '10px' }}>
...
export default UniversityCounsellingContainer;
